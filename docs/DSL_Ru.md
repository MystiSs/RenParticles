...
Команда `simulate` позволяет принудительно «прогнать» систему частиц на заданное количество секунд вперёд. Это полезно для демонстрации эффекта «взросления» системы (например, чтобы показать установившийся поток частиц) или для тестирования долгоживущих эффектов без реального ожидания.
