...
* [Эмиттеры](#эмиттеры)
    * [Обработчик: spray](#обработчик-spray)
    * [Обработчик: interval_spray](#обработчик-interval_spray)
* [Обработчик: fragmentation (interval_fragmentation_per_particle)](#обработчик-fragmentation-interval_fragmentation_per_particle)
* [Поведения частиц](#поведения-частиц)
...
## Обработчик: fragmentation (interval_fragmentation_per_particle)
...
* **`system "id"`** (строка): Уникальный идентификатор целевой системы, в которой будут рождаться новые частицы.
